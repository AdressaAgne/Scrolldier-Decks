	...
	<div class="row">
		...
		<div class="row">
			<div class="col-6 col-phone-12">
				<div class="form-element">
					<label for="deck_name">Deck Name <small>Example: “Rise of Urhald”</small></label>
					<input type="text" id="deck_name" name="deck_name" value="" placeholder="Deck Name" />
				</div>
			</div>
			
			<div class="col-6 col-phone-12">
				<div class="form-element">
					<label for="deck_ign">In-Game Name <small>Example: Orangee</small></label>
					<input type="text" id="deck_ign" name="deck_ign" value="" placeholder="In-Game Name" />
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-4 col-tab-12">
				<div class="form-element">
					<label for="deck_id">Scrolldier Deck Link or Id <small>Example: <a href="http://scrolldier.com/deck/1765">http://scrolldier.com/deck/1765</a> or 1765</small></label>
					<input type="text" id="deck_id" name="deck_id" value="" placeholder="Scrolldier Deck Link or ID" />
				</div>
			</div>
		
			<div class="col-8 col-tab-12">
				<div class="form-element">
					<label for="deck_desc">Description <small>“50 Growth scrolls. A great way to boost your collection!
					...
					<div class="textarea">
						<textarea id="deck_desc" rows="5" placeholder="Description of your deck"></textarea>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-12">
				<div class="form-element">
					<button type="submit" name="submit" class="btn">Submit Deck</button>
				</div>
			</div>
		</div>
